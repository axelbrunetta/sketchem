# This file contains the main function that compares a drawn molecule against a target SMILES string using various comparison methods (the only usefuls one are mcs and using gemini, the rest are POCs) -> works locally but issues when used with Streamlit cloud
